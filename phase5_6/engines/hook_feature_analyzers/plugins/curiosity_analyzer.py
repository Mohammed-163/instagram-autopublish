...
from engines.hook_feature_analyzers.plugins._lexicon import CURIOSITY_WORDS
from engines.hook_feature_analyzers.plugins._keyword_utils import find_first_position


class CuriosityAnalyzer(HookFeatureAnalyzer):
    @property
    def feature_name(self) -> str:
        return "has_curiosity_word"
    ...
    def analyze(self, hook_text: str) -> Dict[str, Any]:
        present, position = find_first_position(hook_text, CURIOSITY_WORDS)
        return {
