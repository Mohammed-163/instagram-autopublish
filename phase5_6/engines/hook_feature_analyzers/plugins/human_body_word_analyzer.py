...
from engines.hook_feature_analyzers.plugins._lexicon import HUMAN_BODY_WORDS
from engines.hook_feature_analyzers.plugins._keyword_utils import find_first_position


class HumanBodyWordAnalyzer(HookFeatureAnalyzer):
    @property
    def feature_name(self) -> str:
        return "has_human_body_word"
    ...
    def analyze(self, hook_text: str) -> Dict[str, Any]:
        present, position = find_first_position(hook_text, HUMAN_BODY_WORDS)
        return {
