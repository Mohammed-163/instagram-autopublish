...
from engines.hook_feature_analyzers.plugins._lexicon import TIME_REFERENCE_WORDS
from engines.hook_feature_analyzers.plugins._keyword_utils import find_first_position


class TimeReferenceAnalyzer(HookFeatureAnalyzer):
    @property
    ...
    def analyze(self, hook_text: str) -> Dict[str, Any]:
        present, position = find_first_position(hook_text, TIME_REFERENCE_WORDS)
        return {
