...
from engines.hook_feature_analyzers.plugins._lexicon import COMPARISON_WORDS
from engines.hook_feature_analyzers.plugins._keyword_utils import find_first_position


class ComparisonAnalyzer(HookFeatureAnalyzer):
    @property
    ...
    def analyze(self, hook_text: str) -> Dict[str, Any]:
        present, position = find_first_position(hook_text, COMPARISON_WORDS)
        return {
