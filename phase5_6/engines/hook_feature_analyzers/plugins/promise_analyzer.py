...
from engines.hook_feature_analyzers.plugins._lexicon import PROMISE_WORDS
from engines.hook_feature_analyzers.plugins._keyword_utils import find_first_position


class PromiseAnalyzer(HookFeatureAnalyzer):
    @property
    ...
    def analyze(self, hook_text: str) -> Dict[str, Any]:
        present, position = find_first_position(hook_text, PROMISE_WORDS)
        return {
