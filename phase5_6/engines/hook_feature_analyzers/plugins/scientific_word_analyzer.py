...
from engines.hook_feature_analyzers.plugins._lexicon import SCIENTIFIC_WORDS
from engines.hook_feature_analyzers.plugins._keyword_utils import find_first_position


class ScientificWordAnalyzer(HookFeatureAnalyzer):
    @property
    def feature_name(self) -> str:
        return "has_scientific_word"
    ...
    def analyze(self, hook_text: str) -> Dict[str, Any]:
        present, position = find_first_position(hook_text, SCIENTIFIC_WORDS)
        return {
